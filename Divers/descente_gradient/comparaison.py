...
#ax.contour(X, Y, Z, 50, rstride=1, cstride=1, cmap='binary')
...
while True:
    ...
    ax.scatter(x1, y1, fonction(x1, y1), marker='o', s=10, color='#FF0000', label="toto")
    ax.scatter(x2, y2, fonction(x2, y2), marker='o', s=10, color='#00FF00', label="tutu")
    plt.draw()
